...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/ziye01/xhAbb/src/industrial_core/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/ziye01/xhAbb/devel/.private/industrial_trajectory_filters)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/ziye01/xhAbb/install)
...
if(NOT "/home/ziye01/xhAbb/src/industrial_core/industrial_trajectory_filters/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3 " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/ziye01/xhAbb/src/industrial_core/industrial_trajectory_filters/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ziye01/xhAbb/src/industrial_core/industrial_trajectory_filters/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ziye01/xhAbb/devel/.private/industrial_trajectory_filters/lib;/home/ziye01/xhAbb/devel/lib;/home/ziye01/kinova_mvig/devel/lib;/home/ziye01/rfmoveit/devel/lib;/opt/ros/noetic/lib)
